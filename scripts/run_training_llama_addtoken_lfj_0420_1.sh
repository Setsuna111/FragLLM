...
deepspeed --include "localhost:1" --master_port $MASTER_PORT  scripts/train_llama_addtoken.py \
    ...
    --protein_sam_checkpoint_path './model_grounding_segformer/checkpoints_grounding_3B_cluster_70/checkpoint_epoch_15.pt' \
    ...
    --root_dir "./data_70" \
    --dataset_train_config "ActGroundSingle||BindIGroundSingle||MotifGroundSingle||EvoGroundSingle" \
    --max_sequence_length 1021 \
    --filter_sequence False \
    --output_dir "/home/dataset-local/projects_dir/FragLLM/checkpoints/0420_grounding_small_4_single_only" \
    --num_train_epochs 50 \
