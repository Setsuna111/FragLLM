...
from instructbiomol_reference_common_v6 import (  # noqa: E402
    FoldseekRunner,
    add_common_args,
    batched,
    full_structure_path,
...
def parse_args() -> argparse.Namespace:
    ...
    parser.set_defaults(data_dir="data_70")
...
def evaluate_dataset(dataset_name: str, model, args: argparse.Namespace) -> Path:
    ...
    if args.dry_run:
        ...
        out_dir = make_output_dir(dry_args, "grounding_single_v6")
    else:
        out_dir = make_output_dir(args, "grounding_single_v6")
