...
def parse_args():
    ...
    parser.add_argument("--model_path", default="/home/dataset-local/projects_dir/FragLLM/checkpoints/0529_all/checkpoint-315000_merge/")
    ...
    parser.add_argument("--datasets", default="ActGroundSingle,BindIGroundSingle,MotifGroundSingle,EvoGroundSingle,DomGroundSingle", help="comma-separated list of datasets to evaluate")
    ...
    parser.add_argument("--model_identifier", default="grounding_lora_0529_all_315000", help="identifier for the model to distinguish different configurations")
