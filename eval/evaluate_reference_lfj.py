...
argParser.add_argument("--model_path", help="path to the trained model", default="/home/lfj/projects_dir/FragLLM/checkpoints/test_load_stage1_both_motifdesc_motifcls_lora_merge/")
