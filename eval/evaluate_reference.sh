...
MODEL_PATH="/home/lfj/projects_dir/FragLLM/checkpoints/test_load_stage1_both_motifdesc_motifcls_lora_merge/"
ROOT_DIR="./data"
RESULTS_DIR="./results/results_reference"
...
MASTER_PORT=24999     # Master port for distributed training
