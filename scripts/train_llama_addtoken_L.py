...
import logging
from models.protein_llama_L import *
...
def train(attn_implementation=None):
    ...
    if model_args.esm_path is not None:
        ...
        model.config.pos_start_placeholder_id = llama_tokenizer.convert_tokens_to_ids(data_args.pos_start_placeholder)
        model.config.pos_end_placeholder_id = llama_tokenizer.convert_tokens_to_ids(data_args.pos_end_placeholder)
        ...
        # model.config.pos_start_placeholder_id = 128256
        # model.config.pos_end_placeholder_id = 128257
        # model.config.phrase_start_placeholder_id = 128258
        # model.config.phrase_end_placeholder_id = 128259
