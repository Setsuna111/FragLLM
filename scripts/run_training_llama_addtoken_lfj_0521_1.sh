...
deepspeed --include "localhost:2,3" --master_port $MASTER_PORT  scripts/train_llama_addtoken.py \
    ...
    --root_dir "./data_70" \
    --dataset_train_config "ActGroundSingle||BindIGroundSingle||MotifGroundSingle||EvoGroundSingle||ActGroundGroup||BindIGroundGroup||EvoGroundGroup||MotifGroundGroup" \
    --max_sequence_length 1021 \
    --filter_sequence False \
    --output_dir "/home/dataset-local/projects_dir/FragLLM/checkpoints/0521_grounding_small_8" \
    --num_train_epochs 50 \
