...
# --include localhost:0
deepspeed --master_port $MASTER_PORT  scripts/train_llama_addtoken.py \
    ...
    --load_adapter_checkpoint_dir "/data/djy/FragLLM_git/checkpoints_contrast/checkpoints_allgather_250827_143913/model_checkpoint_6.pt" \
    --dropout_rate 0.3 \
    ...
    --root_dir "./data" \
    --dataset_train_config "ActGroundSingle||BindIGroundSingle||EvoGroundSingle||MotifGroundSingle" \
    --sample_rate_train "1,1,1,1" \
    --max_sequence_length 1021 \
    --filter_sequence False \
    --output_dir "/data/djy/FragLLM_git/checkpoints/fragment_training_stage2_bw_stage1_concat_lora32_0915_epoch1_allsmallsingle_lr2e4_stage1_checkpoint_6_addtoken_test" \
    --num_train_epochs 1 \
