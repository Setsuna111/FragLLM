...
# MODEL_PATH="/data/djy/FragLLM_git/checkpoints/fragment_training_stage2_bw_stage1_concat_lora32_0915_epoch5_allground_lr2e4_stage1_checkpoint_6_addtoken_merge/"
# ROOT_DIR="./data"
# RESULTS_DIR="./eval_results/fragment_training_stage2_bw_stage1_concat_lora32_0915_epoch5_allground_lr2e4_stage1_checkpoint_6_addtoken_merge/group_grounding"


# Model and data paths
MODEL_PATH="./checkpoints/fragment_training_stage2_bw_stage1_concat_lora32_0917_epoch30_actsingle_lr2e4_stage1_checkpoint_12_addtoken_adapterfea_L_merge"
ROOT_DIR="./data"
RESULTS_DIR="./eval_results/fragment_training_stage2_bw_stage1_concat_lora32_0917_epoch30_actsingle_lr2e4_stage1_checkpoint_12_addtoken_adapterfea_L_merge/single_grounding"
...
if [ "$USE_SINGLE_GPU" = true ]; then
    ...
    python eval_local_addtoken_L/evaluate_grounding.py \
    ...
    torchrun \
        ...
        eval_local_addtoken_L/evaluate_grounding.py \
        --model_path "$MODEL_PATH" \
        --root_dir "$ROOT_DIR" \
        --datasets "$DATASETS" \
        --split "$SPLIT" \
