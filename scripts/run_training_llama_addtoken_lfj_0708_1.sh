...
deepspeed --include "localhost:2,3" --master_port $MASTER_PORT  scripts/train_llama_addtoken.py \
    ...
    --protein_sam_checkpoint_path './model_grounding_segformer/checkpoints_grounding_3B_cluster_frag_50_point_only/checkpoint_epoch_50.pt' \
    ...
    --output_dir "/home/dataset-local/projects_dir/FragLLM/checkpoints/0708_all" \
    --num_train_epochs 50 \
