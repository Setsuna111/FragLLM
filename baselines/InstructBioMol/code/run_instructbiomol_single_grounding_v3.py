...
from instructbiomol_reference_common_v3 import (  # noqa: E402
    FoldseekRunner,
    add_common_args,
    batched,
    full_structure_path,
...
def build_single_prompt(sample: Dict) -> str:
    return (
        ...
        "Use 0-based inclusive residue coordinates. This is a coordinate extraction task; "
        "function descriptions, protein names, and category names receive zero score. "
        "Return only ASCII text in this format: "
...
def evaluate_dataset(dataset_name: str, model, args: argparse.Namespace) -> Path:
    ...
    if args.dry_run:
        ...
        out_dir = make_output_dir(dry_args, "grounding_single_v3")
    else:
        out_dir = make_output_dir(args, "grounding_single_v3")
