...
MODEL_PATH="/home/dataset-local/projects_dir/FragLLM/checkpoints/0521_grounding_small_8/checkpoint-19500_merge/"
ROOT_DIR="./data"
RESULTS_DIR="./eval_results/grounding_single"
MODEL_IDENTIFIER="grounding_lora_0521_small_8"  # Identifier for this model configuration
...
# export CUDA_VISIBLE_DEVICES=0  # Specify visible GPUs for multi-GPU mode
...
DATASETS="ActGroundSingle,BindIGroundSingle,MotifGroundSingle,EvoGroundSingle"
# DATASETS="ActGroundGroup,BindIGroundGroup,EvoGroundGroup,MotifGroundGroup"
...
if [ "$USE_SINGLE_GPU" = true ]; then
    ...
    python eval/evaluate_grounding_addtoken_lfj.py \
    ...
    torchrun \
        ...
        eval/evaluate_grounding_addtoken_lfj.py \
        --model_path "$MODEL_PATH" \
        --root_dir "$ROOT_DIR" \
        --datasets "$DATASETS" \
        --split "$SPLIT" \
