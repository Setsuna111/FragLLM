...
deepspeed --include "localhost:3" --master_port $MASTER_PORT  scripts/train_llama_addtoken.py \
    ...
    --protein_sam_checkpoint_path './model_grounding_segformer/checkpoints_grounding_3B_sigmoid_head/best_model.pt' \
    ...
    --output_dir "/home/dataset-local/projects_dir/FragLLM/checkpoints/0409_grounding_small_4_single_only" \
    --num_train_epochs 50 \
