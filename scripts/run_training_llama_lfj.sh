...
deepspeed  --include "localhost:0,1" --master_port $MASTER_PORT  scripts/train_llama_lfj.py \
    ...
    --load_adapter_checkpoint_dir "/home/lfj/projects_dir/FragLLM/checkpoints_contrast/checkpoints_allgather_250902_175323/model_checkpoint_2.pt" \
    --dropout_rate 0.3 \
    ...
    --root_dir "./data" \
    --dataset_train_config "MotifRefDesc" \
    --sample_rate_train "1" \
    --max_sequence_length 1021 \
    --filter_sequence False \
    --output_dir "./checkpoints/test_load_stage1_only_motifdesc" \
    --num_train_epochs 12 \
