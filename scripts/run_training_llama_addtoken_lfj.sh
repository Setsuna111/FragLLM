...
deepspeed --include "localhost:4" --master_port $MASTER_PORT  scripts/train_llama_addtoken_lfj.py \
    ...
    --protein_sam_checkpoint_path '/home/lfj/projects_dir/FragLLM/model_grounding_segformer/checkpoints_grounding_3B/checkpoint_epoch_0.pt' \
    ...
    --root_dir "./data" \
    --dataset_train_config "ActRefClass||ActGroundSingle" \
