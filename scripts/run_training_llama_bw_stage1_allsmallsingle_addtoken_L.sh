...
# --include localhost:0
deepspeed --master_port $MASTER_PORT  scripts/train_llama_addtoken_L.py \
    ...
    --load_adapter_checkpoint_dir "/data/djy/FragLLM_git/checkpoints_contrast/checkpoints_allgather_250827_143913/model_checkpoint_12.pt" \
    --dropout_rate 0.3 \
    ...
    --root_dir "./data" \
    --dataset_train_config "ActGroundSingle||BindIGroundSingle||EvoGroundSingle||MotifGroundSingle||DomGroundSingle" \
    --sample_rate_train "1,1,1,1,1" \
    --max_sequence_length 1021 \
    --filter_sequence False \
    --output_dir "./checkpoints/fragment_training_stage2_bw_stage1_concat_lora32_0918_epoch30_allsingle_lr2e4_stage1_checkpoint_12_addtoken_adapterfea_L" \
    --num_train_epochs 30 \
