...
deepspeed --include "localhost:1" --master_port $MASTER_PORT  scripts/train_llama_addtoken.py \
    ...
    --protein_sam_checkpoint_path './model_grounding_segformer/checkpoints_grounding_3B_cluster_70/checkpoint_epoch_40.pt' \
    ...
    --output_dir "/home/dataset-local/projects_dir/FragLLM/checkpoints/0430_grounding_all" \
    --num_train_epochs 50 \
